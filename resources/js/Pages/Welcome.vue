...
<template>
    ...
    >
        ...
        <div class="w-9/12 mx-auto">
            ...
            <div
                class="container mt-16 p-10 bg-white rounded-lg shadow-2xl shadow-gray-500/20"
            >
                <form>
                    <div class="w-full">
                        <div class="">
                            <h2
                                class="text-2xl text-center font-semibold leading-7 text-gray-900 p-8"
                            >
                                Form Data Diri
                            </h2>
                            ...
                            <div class="mt-10 grid grid-cols-2 gap-x-6 gap-y-8">
                                <label
                                    for="nama_lengkap"
                                    class="block text-sm font-medium leading-6 w-full text-gray-900"
                                    >Nama Lengkap</label
                                >
                                <input
                                    type="text"
